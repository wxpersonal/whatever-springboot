...
//    //packages("me.weix.whatever.controller","com.logic.landseaserver.ws");
...
//    this.registerClasses(scanner.findCandidateComponents("me.weix.whatever.controller").stream()
//            .map(beanDefinition -> ClassUtils
//                    .resolveClassName(beanDefinition.getBeanClassName(), this.getClassLoader()))
//            .collect(Collectors.toSet()));
////    packages("me.weix.whatever.controller");
//  }
//
//  @PostConstruct
//  public void init() {
...
//    config.setResourcePackage("me.weix.whatever.controller");
