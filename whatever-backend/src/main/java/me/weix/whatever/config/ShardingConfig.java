...
import me.weix.whatever.config.sharding.DatabaseShardingAlgorithm;
import me.weix.whatever.config.sharding.TablePreciseShardingAlgorithm;
import me.weix.whatever.config.sharding.TableRangeShardingAlgorithm;
...
public class ShardingConfig {
    ...
    @ConfigurationProperties(prefix = "sharding.jdbc.datasource.ds-master1")
    @Bean(name = "ds_1")
